;;; yasnippet-lean-autoloads.el --- automatically extracted autoloads  -*- lexical-binding: t -*-
;;
;;; Code:
...
Load the `yasnippet-lean' snippets directory." nil nil)

(eval-after-load 'yasnippet '(yasnippet-lean-initialize))

(register-definition-prefixes "yasnippet-lean" '("yasnippet-lean-dir"))
