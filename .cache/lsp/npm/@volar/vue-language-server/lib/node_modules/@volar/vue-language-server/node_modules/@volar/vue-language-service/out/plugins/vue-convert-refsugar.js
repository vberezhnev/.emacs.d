            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                for (const declaration of ranges) {
                    ...
                    for (const binding of declaration.leftBindings) {
                        const definitions = (_b = yield findTypeDefinition(document.uri, document.positionAt(startTagEnd + binding.end))) !== null && _b !== void 0 ? _b : [];
                        const _isRefType = (0, vue_autoinsert_dotvalue_1.isRefType)(definitions, scriptTsLs);
                        if (!_isRefType)
                            continue;
                        isRefDeclaration = true;
                        let references = (_c = yield findReferences(document.uri, document.positionAt(startTagEnd + binding.end))) !== null && _c !== void 0 ? _c : [];
                        references = references.filter(reference => {
                            ...
                            if (end < startTagEnd || start > startTagEnd + _scriptSetup.content.length)
                                return false;
                            if ((0, vue_autoinsert_dotvalue_1.isBlacklistNode)(ts, _scriptSetupAst, start - startTagEnd))
                                return false;
                            return true;
                        });
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                for (const callRange of ranges.refs) {
                    ...
                    for (const binding of callRange.leftBindings) {
                        ...
                        const renames = yield doRename(_vueDocument.uri, document.positionAt(startTagEnd + binding.end), bindingName + '.value');
