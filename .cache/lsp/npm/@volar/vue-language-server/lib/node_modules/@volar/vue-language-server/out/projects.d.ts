        ...
        getProjectAndTsConfig: (uri: string) => Promise<{
            ...
            project: {
                ...
                getParsedCommandLine: () => ts.ParsedCommandLine & {
                    vueOptions: Partial<import("@volar/vue-language-core")._VueCompilerOptions>;
                };
                dispose: () => void;
            };
        } | undefined>;
