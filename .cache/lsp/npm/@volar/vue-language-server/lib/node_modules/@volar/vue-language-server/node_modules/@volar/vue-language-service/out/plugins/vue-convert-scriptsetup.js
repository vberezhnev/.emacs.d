            ...
            on(document) {
                return worker(document.uri, (vueDocument) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    if (descriptor.scriptSetup) {
                        const startTagEnd = (_c = compiledVue.getSourceRange(descriptor.scriptSetup.startTagEnd)) === null || _c === void 0 ? void 0 : _c[0].start;
                        if (startTagEnd) {
                            result.push({
                                range: {
                        ...
                        const startTagEnd = (_d = compiledVue.getSourceRange(descriptor.script.startTagEnd)) === null || _d === void 0 ? void 0 : _d[0].start;
                        if (startTagEnd) {
                            result.push({
                                range: {
                                    start: document.positionAt(startTagEnd),
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        function getEdits(_vueDocument, _script, _scriptAst) {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const startTagEnd = (_a = compiledVue.getSourceRange(_script.startTagEnd)) === null || _a === void 0 ? void 0 : _a[0].start;
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        function getEdits(_vueDocument, _script, _scriptSetup, _scriptAst, _scriptSetupAst) {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const compiledVue = _vueDocument.file.getCompiledVue();
                const startTagEnd = (_a = compiledVue.getSourceRange(_scriptSetup.startTagEnd)) === null || _a === void 0 ? void 0 : _a[0].start;
                if (startTagEnd === undefined)
                    return;
                const document = _vueDocument.getDocument();
                const edits = [];
