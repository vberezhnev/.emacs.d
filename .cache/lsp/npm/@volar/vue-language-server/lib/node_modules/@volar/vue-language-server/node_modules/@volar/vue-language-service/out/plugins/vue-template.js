...
function useVueTemplateLanguagePlugin(options) {
    ...
    function resolveAutoImportItem(item, data) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (descriptor.scriptSetup) {
                const startTagEnd = (_b = compiledVue.getSourceRange(descriptor.scriptSetup.startTagEnd)) === null || _b === void 0 ? void 0 : _b[0].start;
                ...
                const startTagEnd = (_c = compiledVue.getSourceRange(descriptor.script.startTagEnd)) === null || _c === void 0 ? void 0 : _c[0].start;
                if (startTagEnd !== undefined) {
                    ...
                    if (exportDefault) {
                        ...
                        if (exportDefault.componentsOption && exportDefault.componentsOptionNode) {
                            ...
                            const editRange = vscode.Range.create(textDoc.positionAt(startTagEnd + exportDefault.componentsOption.start), textDoc.positionAt(startTagEnd + exportDefault.componentsOption.end));
                            ...
                            const printText = printer.printNode(options.ts.EmitHint.Expression, newNode, scriptAst);
                            const editRange = vscode.Range.create(textDoc.positionAt(startTagEnd + exportDefault.args.start), textDoc.positionAt(startTagEnd + exportDefault.args.end));
                            autoImportPositions.add(editRange.start);
                            autoImportPositions.add(editRange.end);
                            item.additionalTextEdits.push(vscode.TextEdit.replace(editRange, unescape(printText.replace(/\\u/g, '%u'))));
                        }
            ...
            function getTypeScriptInsert() {
                ...
                return __awaiter(this, void 0, void 0, function* () {
                    ...
                    let [formatOptions, preferences] = yield Promise.all([
                        (_b = (_a = options.tsSettings).getFormatOptions) === null || _b === void 0 ? void 0 : _b.call(_a, embeddedScriptUri),
                        (_d = (_c = options.tsSettings).getPreferences) === null || _d === void 0 ? void 0 : _d.call(_c, embeddedScriptUri),
                    ]);
                    formatOptions = formatOptions !== null && formatOptions !== void 0 ? formatOptions : {};
    ...
    function getComponentCompletionData(sourceFile) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!cache) {
                cache = new Map();
                const file = (_a = sourceFile.file.getAllEmbeddeds().find(e => e.file.fileName.endsWith('.__VLS_template.tsx')
                    || e.file.fileName.endsWith('.__VLS_template.jsx'))) === null || _a === void 0 ? void 0 : _a.file;
