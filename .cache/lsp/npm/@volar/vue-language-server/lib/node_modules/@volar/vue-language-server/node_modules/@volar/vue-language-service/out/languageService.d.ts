...
export declare function createLanguageService(vueLsHost: vue.LanguageServiceHost, fileSystemProvider: html.FileSystemProvider | undefined, schemaRequestService: json.SchemaRequestService | undefined, configurationHost: ConfigurationHost | undefined, customPlugins: EmbeddedLanguageServicePlugin[], getNameCases?: (uri: string) => Promise<{
    ...
    mapper: {
        ...
        fromEmbeddedLocation: (fileName: string, start: number, end?: number | undefined, filter?: ((data: import("@volar/vue-code-gen").EmbeddedFileMappingData) => boolean) | undefined, sourceMapFilter?: ((sourceMap: vue.EmbeddedFileSourceMap) => boolean) | undefined) => Generator<{
            fileName: string;
            range: {
                start: number;
                end: number;
    ...
    doValidation: (uri: string, response?: ((result: html.Diagnostic[]) => void) | undefined, isCancel?: (() => Promise<boolean>) | undefined) => Promise<html.Diagnostic[]>;
    ...
    prepareRename: (uri: string, position: html.Position) => Promise<html.Range | vscode.ResponseError<void> | undefined>;
