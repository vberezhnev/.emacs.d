...
function createLanguageContext(host, extraPlugins = [], exts = ['.vue', '.md', '.html']) {
                ...
                if (exts.some(ext => vueFileName.endsWith(ext))) {
                    ...
                    if (!vueFile) {
                        ...
                        if (fileExists) {
                            ...
                            if (scriptSnapshot) {
                                documentRegistry.set(vueFileName, (0, sourceFile_1.createSourceFile)(vueFileName, scriptSnapshot.getText(0, scriptSnapshot.getLength()), vueCompilerOptions, ts, plugins));
                            }
                        }
                    }
                }
    ...
    function update() {
        ...
        for (const fileName of [
            ...
            if (!sourceFile) {
                documentRegistry.set(fileName, (0, sourceFile_1.createSourceFile)(fileName, scriptText, vueCompilerOptions, ts, plugins));
                tsFileUpdated = true;
            }
            else {
                const oldScripts = {};
    ...
    function getScriptVersion(fileName) {
        ...
        if (mapped) {
            if (fileVersions.has(mapped.embedded.file)) {
                ...
                let version = (_c = (_b = (_a = ts.sys).createHash) === null || _b === void 0 ? void 0 : _b.call(_a, mapped.embedded.file.codeGen.getText())) !== null && _c !== void 0 ? _c : mapped.embedded.file.codeGen.getText();
                if (host.isTsc) {
