 ...
 * TODO: rewrite this
 */
function generate(ts, fileName, sfc, lang, scriptRanges, scriptSetupRanges, cssVars, cssModuleClasses, cssScopedClasses, htmlGen, compilerOptions, codeGen = new code_gen_1.CodeGen(), teleports = []) {
    var _a;
    ...
    const vueVersion = (_a = compilerOptions.target) !== null && _a !== void 0 ? _a : 3;
    ...
    function writeTemplateContext() {
        ...
        codeGen.addText(`let __VLS_selfComponent!: __VLS_types.SelfComponent<typeof __VLS_name, typeof __VLS_component & (new () => { ${(0, shared_2.getSlotsPropertyName)((_a = compilerOptions.target) !== null && _a !== void 0 ? _a : 3)}: typeof __VLS_slots })>;\n`);
    ...
    function getImplicitWrapComponentOptionsMode(lang) {
        ...
        if (compilerOptions.experimentalImplicitWrapComponentOptionsWithVue2Extend === 'onlyJs'
            ? lang === 'js' || lang === 'jsx'
            : !!compilerOptions.experimentalImplicitWrapComponentOptionsWithVue2Extend) {
            shimComponentOptionsMode = 'Vue.extend';
        }
        if (compilerOptions.experimentalImplicitWrapComponentOptionsWithDefineComponent === 'onlyJs'
            ? lang === 'js' || lang === 'jsx'
