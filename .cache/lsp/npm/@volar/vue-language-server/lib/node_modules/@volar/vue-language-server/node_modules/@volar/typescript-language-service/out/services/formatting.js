...
function register(languageService, getTextDocument, settings) {
    return {
        onRange: (uri, options, range) => __awaiter(this, void 0, void 0, function* () {
            ...
            const tsOptions = (_b = yield ((_a = settings.getFormatOptions) === null || _a === void 0 ? void 0 : _a.call(settings, document.uri, options))) !== null && _b !== void 0 ? _b : options;
            let scriptEdits;
            try {
                scriptEdits = range
        ...
        onType: (uri, options, position, key) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (!document)
                return [];
            const fileName = shared.uriToFsPath(document.uri);
            const tsOptions = (_e = yield ((_d = settings.getFormatOptions) === null || _d === void 0 ? void 0 : _d.call(settings, document.uri, options))) !== null && _e !== void 0 ? _e : options;
            let scriptEdits;
            try {
