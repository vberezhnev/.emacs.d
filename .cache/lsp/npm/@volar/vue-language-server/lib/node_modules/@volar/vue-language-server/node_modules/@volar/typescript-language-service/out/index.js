    ...
    function getTextDocument(uri) {
        ...
        if (!oldDoc || oldDoc[0] !== version) {
            ...
            if (scriptSnapshot) {
                ...
                const document = vscode_languageserver_textdocument_1.TextDocument.create(uri, shared.syntaxToLanguageId(path_1.posix.extname(uri).slice(1)), oldDoc ? oldDoc[1].version + 1 : 0, scriptText);
