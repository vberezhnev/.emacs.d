    ...
    function getTemplateData() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (file && file.content.indexOf(vue.SearchTexts.Components) >= 0) {
                ...
                let components = yield (tsLs === null || tsLs === void 0 ? void 0 : tsLs.doComplete(shared.fsPathToUri(file.fileName), document.positionAt(file.content.indexOf(vue.SearchTexts.Components)), options));
                if (components) {
