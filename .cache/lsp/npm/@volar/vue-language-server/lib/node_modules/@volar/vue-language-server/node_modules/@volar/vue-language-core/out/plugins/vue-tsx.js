...
const plugin = ({ modules, vueCompilerOptions, compilerOptions }) => {
    ...
    function createGen(fileName, sfc) {
        ...
        const tsxGen = (0, reactivity_1.computed)(() => (0, script_1.generate)(ts, fileName, sfc, lang.value, scriptRanges.value, scriptSetupRanges.value, cssVars.value, cssModuleClasses.value, cssScopedClasses.value, htmlGen.value, vueCompilerOptions));
        return {
            lang,
            htmlGen,
            tsxGen,
