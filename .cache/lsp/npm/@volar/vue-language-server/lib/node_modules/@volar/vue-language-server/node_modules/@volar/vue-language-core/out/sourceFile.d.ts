...
export declare function createSourceFile(fileName: string, _content: string, vueCompilerOptions: VueCompilerOptions, ts: typeof import('typescript/lib/tsserverlibrary'), plugins: ReturnType<VueLanguagePlugin>[]): {
    fileName: string;
    text: string;
